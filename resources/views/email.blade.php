				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1"  style="background-color:white;opacity:0.9">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form action="{{route('admin')}}" method="post" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo1/dist/index.html" >
								@csrf
							<!--begin::Heading-->
                                <center >
							<img alt="Logo" src="../media/logos/edge.png" class="h-75px "  />
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<input type="number" placeholder="Enter the code" name="number" autocomplete="off" class="form-control bg-transparent" />
