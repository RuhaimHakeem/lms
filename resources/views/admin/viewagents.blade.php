                ...
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                            ...
                            function form(id) {
                                return '<form method="POST" action="/deleteagent/' + id + ' "> @csrf @method("delete")<a class="btndelete btn btn-danger btn-sm show_confirm" style= title="Delete" id="show_confirm" data-toggle="tooltip"> Delete </a> </form>'
                            } 
                            ...
                            $(document).ready(function(e) {
                                ...
                                fetchtransaction();  
                                    ...
                                    function fetchtransaction() {
                                        ...
                                        {
                                            data: function(row) {
                                                return  '<div style="display:flex; flex-wrap: no-wrap; align-items:center"> <a href="/updateagent/' + row.id + '" class="edit btn btn-secondary btn-sm mx-4">Update</a> ' + form(row.id) + ' </div>'
                                            }
                                        }
