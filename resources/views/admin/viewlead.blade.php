...
<head>
    <base href="">
    <title>EDGE [Admin] View Lead</title>
    <meta charset="utf-8" />
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            ...
                                            <a class="menu-link" href="/admindashboard/leadnote">
                                                ...
                                                <span class="menu-title">Lead Note</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                                ...
                                <div class="mt-10  ">
                                    ...
                                    <table class="table mt-10 w-25 caption-top ">
                                        <thead>
                                            ...
                                            <tr>
                                                <th id="th">Phone 2</th>
                                                <td>@if(isset($leaddetails->phonenumber2))
                                                    {{$leaddetails->phonenumber2}} @else
                                                    Null @endif</td>
                                            </tr>
                                            <tr>
                                                <th id="th">Country</th>
                                                <td>@if(isset($countrydetails->countryname))
                                                    {{$countrydetails->countryname}} @else
                                                    Null @endif</td>
                                            </tr>
                                            <tr>
                                                <th id="th">State</th>
                                                <td>@if(isset($countrydetails->state)) {{$countrydetails->state}}
                                                    @else
                                                    Null @endif</td>
                                            </tr>
                                            <tr>
                                                <th id="th">City</th>
                                                <td> @if(isset($countrydetails->city)) {{$countrydetails->city}}
                                                    @else
                                                    Null @endif</td>
                                            </tr>
                                            <tr>
                                                <th id="th">Position</th>
                                                <td>@if(isset($leaddetails->position)) {{$leaddetails->position}}
                                                    @else
                                                    Null @endif</td>
                                            </tr>
                                            <tr>
                                                <th id="th">Lead Type</th>
                                                <td>@if(isset($leaddetails->leadtype)) {{$leaddetails->leadtype}}
                                                    @else
                                                    Null @endif</td>
                                            </tr>
