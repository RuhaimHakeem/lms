...
<head>
    <base href="../../../">
    <title>EDGE | AGENT REGISTRATION</title>
    <meta charset="utf-8" />
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1"
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form class="form w-100" action="{{route('register-user')}}" method="post">
                ...
                <div class="d-grid ">
                    ...
                    <p class="mb-0 fw-semibold" target="_blank">Engineered by PragICTS <img alt="Logo"
                            src="../media/logos/prag.png" class="h-20px " /></p>
